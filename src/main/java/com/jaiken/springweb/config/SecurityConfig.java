...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http, UserDetailsService customerDetailsService, JwtTokenFilter jwtTokenFilter, CorsConfigurationSource corsConfigurationSource) throws Exception {
